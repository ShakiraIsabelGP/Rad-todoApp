...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47666 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47666(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47667 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47667(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47668 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47668(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47669 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47669(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47670 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47670(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47671 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47671(reader);
}
});
...
var G__47676 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47677 = s.append(c);
c = G__47676;
s = G__47677;
continue;
}
