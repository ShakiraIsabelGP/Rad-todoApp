...
var stack_90071 = [];
var state__90072 = cljs.core.volatile_BANG_(false);
taoensso.tufte.impl.pdata_proxy_get = (function taoensso$tufte$impl$pdata_proxy_get(){
return cljs.core.deref(state__90072);
});

taoensso.tufte.impl.pdata_proxy_pop = (function taoensso$tufte$impl$pdata_proxy_pop(){
var temp__5733__auto__ = stack_90071.pop();
if(cljs.core.truth_(temp__5733__auto__)){
var stashed = temp__5733__auto__;
return cljs.core.vreset_BANG_(state__90072,stashed);
} else {
return cljs.core.vreset_BANG_(state__90072,null);
}
});

taoensso.tufte.impl.pdata_proxy_push = (function taoensso$tufte$impl$pdata_proxy_push(v){
var temp__5733__auto__ = cljs.core.deref(state__90072);
if(cljs.core.truth_(temp__5733__auto__)){
var to_stash = temp__5733__auto__;
stack_90071.push(to_stash);

return cljs.core.vreset_BANG_(state__90072,v);
} else {
return cljs.core.vreset_BANG_(state__90072,v);
}
});
...
var sort_tspans_90077 = (function (tspans){
...
var sorted_tspans = sort_tspans_90077(tspans);
...
var vec__90048 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__90051,id){
var vec__90052 = p__90051;
var pd2_id_times = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90052,(0),null);
var pd2_id_stats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90052,(1),null);
...
var pd2_id_times = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90048,(0),null);
var pd2_id_stats = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90048,(1),null);
...
var G__90192 = pd;
var G__90193 = new cljs.core.Keyword("tufte","compaction","tufte/compaction",357384907);
var G__90194 = (taoensso.encore.now_nano() - t0);
pd = G__90192;
id = G__90193;
ns_elapsed = G__90194;
continue;
...
var G__90195 = pd;
var G__90196 = new cljs.core.Keyword("tufte","compaction","tufte/compaction",357384907);
var G__90197 = (taoensso.encore.now_nano() - t0);
pd = G__90195;
id = G__90196;
ns_elapsed = G__90197;
continue;
...
var vec__90055 = cljs.core.reduce_kv((function (acc,id,times){
if((cljs.core.count(times) <= nmax)){
return acc;
} else {
var vec__90058 = acc;
var id_times__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90058,(0),null);
var id_stats__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90058,(1),null);
var stats_LT_times = taoensso.tufte.stats.stats(times);
...
var id_times__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90055,(0),null);
var id_stats__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90055,(1),null);
