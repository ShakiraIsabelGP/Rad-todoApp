...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__59364){
var vec__59365 = p__59364;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59365,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59365,(1),null);
...
}),null)),null,-609034838,null);
} else {
}

return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__59370 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__59371 = data__$1;
var G__59372 = tables;
var G__59373 = union_seen;
var G__59374 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__59370,G__59371,G__59372,G__59373,G__59374) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__59370,G__59371,G__59372,G__59373,G__59374));
...
var vec__59386 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var join_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59386,(0),null);
var subquery = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59386,(1),null);
...
var G__59403 = cljs.core.next(q);
var G__59404 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,i);
q = G__59403;
ret = G__59404;
continue;
} else {
var G__59405 = cljs.core.next(q);
var G__59406 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,x);
q = G__59405;
ret = G__59406;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__59368_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(subquery__$1,p1__59368_SHARP_,tables,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,subquery__$1,p1__59368_SHARP_,tables,union_entry,transform));
});})(q,ret,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.raw.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (p1__59369_SHARP_){
return com.fulcrologic.fulcro.raw.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,com.fulcrologic.fulcro.algorithms.normalize.hide_not_found(p1__59369_SHARP_));
});})(q,ret,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(subquery__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(tables,((function (q,ret,is,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__59389){
var vec__59390 = p__59389;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59390,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59390,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
return (function (tables_SINGLEQUOTE_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1){
return (function com$fulcrologic$fulcro$algorithms$normalize$normalize_STAR__$_merge_to_client_db(state,p__59393){
var vec__59394 = p__59393;
var ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59394,(0),null);
var entity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59394,(1),null);
return com.fulcrologic.fulcro.algorithms.normalize.upsert_ident(state,ident,entity);
});})(q,ret,is,xs,vec__59386,join_key,subquery,recursive_QMARK_,union_entry,subquery__$1,class$,v,expr,data__$1))
...
var G__59407 = cljs.core.next(q);
var G__59408 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,is);
q = G__59407;
ret = G__59408;
continue;
} else {
var G__59409 = cljs.core.next(q);
var G__59410 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,xs);
q = G__59409;
ret = G__59410;
continue;
}
...
if((v == null)){
var G__59411 = cljs.core.next(q);
var G__59412 = ret;
q = G__59411;
ret = G__59412;
continue;
} else {
var G__59413 = cljs.core.next(q);
var G__59414 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,join_key,v);
q = G__59413;
ret = G__59414;
continue;
...
if((v == null)){
var G__59415 = cljs.core.next(q);
var G__59416 = ret;
q = G__59415;
ret = G__59416;
continue;
} else {
var G__59417 = cljs.core.next(q);
var G__59418 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__59417;
ret = G__59418;
continue;
}
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Normalize failed and no data will be inserted into the client DB. Error:",cljs.core.ex_message(e),(function (){var temp__5733__auto__ = (function (){var G__59398 = query;
var G__59398__$1 = (((G__59398 == null))?null:cljs.core.meta(G__59398));
var G__59398__$2 = (((G__59398__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__59398__$1));
if((G__59398__$2 == null)){
return null;
} else {
return com.fulcrologic.fulcro.raw.components.component_name(G__59398__$2);
}
})();
