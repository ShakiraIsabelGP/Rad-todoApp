...
var vec__55198 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55198,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55198,(1),null);
...
var expr__$1 = (function (){var G__55201 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__55201);
} else {
return G__55201;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__55202 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__55202) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__55202));
} else {
return expr;
...
var len__4736__auto___55214 = arguments.length;
var i__4737__auto___55215 = (0);
while(true){
if((i__4737__auto___55215 < len__4736__auto___55214)){
args__4742__auto__.push((arguments[i__4737__auto___55215]));

var G__55216 = (i__4737__auto___55215 + (1));
i__4737__auto___55215 = G__55216;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq55203){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55203));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55205 = query;
var G__55205__$1 = (((G__55205 == null))?null:cljs.core.meta(G__55205));
var G__55205__$2 = (((G__55205__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__55205__$1));
if((G__55205__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__55205__$2) : component_name_fn.call(null,G__55205__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,-1630555871,null);
} else {
}
