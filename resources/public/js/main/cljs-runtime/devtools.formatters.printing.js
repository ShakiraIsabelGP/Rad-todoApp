...
var G__52365 = (i__4737__auto___52364 + (1));
i__4737__auto___52364 = G__52365;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52344){
var G__52345 = cljs.core.first(seq52344);
var seq52344__$1 = cljs.core.next(seq52344);
var G__52346 = cljs.core.first(seq52344__$1);
var seq52344__$2 = cljs.core.next(seq52344__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52345,G__52346,seq52344__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52347_SHARP_){
return (!((cljs.core.meta(p1__52347_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52348__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e52352){var _e__49266__auto__ = e52352;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e52354){var _e__49266__auto__ = e52354;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__52356 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__52357 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__52357);

try{var map__52358 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52358__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__52356);
}});
...
var temp__5733__auto___52386 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___52386)){
var managed_print_level_52389 = temp__5733__auto___52386;
var _STAR_print_level_STAR__orig_val__52361_52390 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__52362_52391 = managed_print_level_52389;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__52362_52391);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__52360_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__52360_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__52361_52390);
}} else {
job_fn();
}
