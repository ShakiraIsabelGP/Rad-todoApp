...
var i__4737__auto___52225 = (0);
while(true){
if((i__4737__auto___52225 < len__4736__auto___52224)){
args__4742__auto__.push((arguments[i__4737__auto___52225]));

var G__52226 = (i__4737__auto___52225 + (1));
i__4737__auto___52225 = G__52226;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq52221){
var G__52222 = cljs.core.first(seq52221);
var seq52221__$1 = cljs.core.next(seq52221);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52222,seq52221__$1);
}));
...
return cljs.core.some((function (p1__52223_SHARP_){
return (p1__52223_SHARP_ === object);
}),history);
});
