 ...
 */
com.fulcrologic.fulcro.react.version18.with_react18 = (function com$fulcrologic$fulcro$react$version18$with_react18(app){
var reactRoot = cljs.core.volatile_BANG_(null);
return cljs.core.assoc_in(cljs.core.assoc_in(app,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("com.fulcrologic.fulcro.application","algorithms","com.fulcrologic.fulcro.application/algorithms",-397334538),new cljs.core.Keyword("com.fulcrologic.fulcro.algorithm","render-root!","com.fulcrologic.fulcro.algorithm/render-root!",1033047)], null),(function (ui_root,mount_node){
if(cljs.core.truth_(cljs.core.deref(reactRoot))){
} else {
cljs.core.vreset_BANG_(reactRoot,module$node_modules$react_dom$client.createRoot(mount_node));
}
