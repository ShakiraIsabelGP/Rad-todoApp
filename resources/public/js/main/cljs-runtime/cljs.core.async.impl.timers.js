...
var i_49444 = (0);
while(true){
if((i_49444 < arr.length)){
(arr[i_49444] = null);

var G__49445 = (i_49444 + (1));
i_49444 = G__49445;
continue;
} else {
}
...
var i_49452 = (self__.level + (1));
while(true){
if((i_49452 <= (new_level + (1)))){
(update[i_49452] = self__.header);

var G__49453 = (i_49452 + (1));
i_49452 = G__49453;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_49454 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_49454[i]));
} else {
x__$2.forward.push((((i < links_49454.length))?(links_49454[i]):null));
}

if((i < links_49454.length)){
(links_49454[i] = x__$2);
} else {
links_49454.push(x__$2);
}
...
var i_49456 = (0);
while(true){
if((i_49456 <= self__.level)){
var links_49457 = (update[i_49456]).forward;
if((x__$1 === (((i_49456 < links_49457.length))?(links_49457[i_49456]):null))){
(links_49457[i_49456] = (x__$1.forward[i_49456]));

var G__49458 = (i_49456 + (1));
i_49456 = G__49458;
continue;
} else {
var G__49459 = (i_49456 + (1));
i_49456 = G__49459;
continue;
}
} else {
...
var G__49461 = nx;
var G__49462 = (level__$1 - (1));
x = G__49461;
level__$1 = G__49462;
continue;
} else {
var G__49463 = x;
var G__49464 = (level__$1 - (1));
x = G__49463;
level__$1 = G__49464;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__49466 = nx;
var G__49467 = (level__$1 - (1));
x = G__49466;
level__$1 = G__49467;
continue;
} else {
var G__49468 = x;
var G__49469 = (level__$1 - (1));
x = G__49468;
level__$1 = G__49469;
continue;
}
